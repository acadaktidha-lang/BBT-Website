...
function LayoutContent() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <EnrollmentSidebar isOpen={isEnrollmentSidebarOpen} onClose={closeEnrollmentSidebar} />
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl shadow-xl relative overflow-visible">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          ...
          ></div>
          <div
            className="absolute top-0 right-1/4 w-80 h-80 bg-blue-600/15 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: '2s', animationDuration: '6s' }}
          ></div>
          <div
            className="absolute bottom-0 left-1/3 w-72 h-72 bg-blue-400/25 rounded-full blur-3xl animate-pulse"
          ...
          <div className="container mx-auto px-4 py-24">
            ...
            <div className="mt-20 pt-16 border-t border-white/10">
              <div className="max-w-5xl mx-auto text-center">
                <h3 className="text-4xl font-black mb-4 text-white">Stay Updated with Latest Tech Trends</h3>
            ...
            <div className="container mx-auto px-4 py-8">
              <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div className="text-white/90 text-center md:text-left">
                  <p className="font-semibold text-lg">&copy; 2026 Big Binary Tech International. All rights reserved.</p>
